...
# Apply the squeezes to the tensor, only if the dimensions exist
        continuous_features = out["embds"].cpu().detach()
        while continuous_features.dim() > 2:
          continuous_features = continuous_features.squeeze(2)

# Check the shape of the tensor after squeezing
